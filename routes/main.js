...
module.exports = function(app, forumData) {
	...
	let sqlquery = `SELECT u.user_id, u.username, u.firstname, u.surname, u.country, t.topic_tile, t.topic_description
			FROM users u
			JOIN topics t
    ...
    app.get('topics/:topics_title', function(req,res){
	res.send(req.params.topics_title)
    });
